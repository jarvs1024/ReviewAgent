...
PROJECT_ID = 34
BRANCH = "codex/8bugs-merged-main-2026-08-05"
TARGET_BRANCH = "main"

MAIN_FILE = "services/verify_8bugs_2026_08_05.py"
...
CALLER_FILE = "services/verify_8bugs_caller_2026_08_05.py"
...
# verify_8bugs_2026_08_05 已经搬到 services/audit/ 子目录,
# 但 caller 还在用旧路径 services.verify_8bugs_2026_08_05 — module 找不到.
from services.verify_8bugs_2026_08_05 import (
    fetch_records,
    save_report,
    start_logging,
)
...
def main():
    ...
    mr = project.mergerequests.create({
        ...
        "title": "test: 8-bug review fixture (post-merge-main deploy)",
        "description": (
