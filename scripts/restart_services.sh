...
#
# 用法:
#   bash scripts/restart_services.sh <command>
#
# 命令:
#   start     启动所有服务
#   stop      停止所有服务
...
#
# 示例:
#   bash scripts/restart_services.sh            # 默认 restart
#   bash scripts/restart_services.sh status     # 查看状态
#   bash scripts/restart_services.sh stop       # 停止
#   bash scripts/restart_services.sh logs       # 跟踪日志
set -eo pipefail
