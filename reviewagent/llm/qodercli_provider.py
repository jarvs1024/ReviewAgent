    ...
    def run(
        ...
        *,
        ...
        try:
            ...
            fallback = config.qodercli_fallback_model
            primary = effective_model or config.qodercli_model
            if not fallback or fallback == primary:
                raise
            logger.warning(
                "qodercli.fallback primary={} fallback={} reason={}",
                primary, fallback, e,
            )
            ...
            logger.info(
                "qodercli.fallback success model={} agent={}",
                fallback, agent,
            )
            return result
